...
- **공용 DNS 교차 검증** — 로컬 설정 DNS 외에도 잘 알려진 공용 리졸버(Google, Cloudflare, OpenDNS, Quad9, Alibaba, Tencent DNSPod, 114DNS, Baidu, AdGuard, NextDNS, Comodo 및 일반적인 IPv6 주소)에 프로브를 보내 DNS 쿼리가 터널 내부만 통과하는지 교차 확인합니다. 공용 리졸버의 응답은 '도달 가능'만 의미하며 누출이 아닙니다.
