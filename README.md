...
| macOS (Apple Silicon / arm64) | 🚧 Experimental — CI-built but not yet tested on real hardware; you may also try [WireTunnels](https://github.com/FMDigitech/WireTunnels), another WireGuard app |
