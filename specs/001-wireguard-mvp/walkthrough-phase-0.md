...
### go.mod
**목적**: `github.com/imonior/wireguide-plus` 모듈. Wails v3 alpha.74 + wireguard-go + wgctrl-go + wintun 의존성.

### frontend/src/App.svelte
**목적**: Wails 템플릿 기본 Svelte 앱. `changeme` → `github.com/imonior/wireguide-plus` 바인딩 경로 수정.
