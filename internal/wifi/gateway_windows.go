...
// GatewayIP returns the IPv4 address of the physical default gateway ("" if
// unknown). Same route lookup as GatewayMAC (underlay, tunnel excluded), so
// the value stays stable while a full tunnel is up.
