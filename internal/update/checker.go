...
const (
	...
	//   go build -ldflags="-X 'github.com/imonior/wireguide-plus/internal/update.expectedPublicKey=<hex>'"
	//
...
func assetMatchesOSArch(name string, osNames []string, arch string) bool {
	...
	// `wireguideplus-<version>-<arch>-installer.exe` / `wireguideplus-<version>-<arch>-portable.zip`
