...
# Offer to launch the app right after installation (checked by default).
# MUI_FINISHPAGE_RUN is evaluated from the finish-page macro at compile time,
# so ${INFO_PRODUCTNAME} (defined above) is already substituted here.
