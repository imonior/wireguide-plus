...
<svelte:window on:keydown={(e) => e.key === 'Escape' && showConfirm && (showConfirm = false)} />
...
{#if showConfirm}
  <div class="popup-backdrop" on:mousedown|self={() => showConfirm = false}>
    <div class="popup" on:mousedown|stopPropagation role="dialog" aria-modal="true" tabindex="-1">
